...
public class CouncilFMessSecy extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CouncilUserClass messMem1=new CouncilUserClass("Amulya G H","Girls Hostel Mess Committee Leader","9769719309","amulya@iitdh.ac.in",R.drawable.gh);
        CouncilUserClass messMem2=new CouncilUserClass("Deekshith","Boys Hostel Mess Committee Leader","167229258"," Deekshith@iitdh.ac.in",R.drawable.mihir);
