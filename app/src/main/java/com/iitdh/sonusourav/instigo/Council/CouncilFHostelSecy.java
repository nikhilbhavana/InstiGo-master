...
public class CouncilFHostelSecy extends AppCompatActivity
    ...
    private androidx.appcompat.app.ActionBar FHostelActionBar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CouncilUserClass jrHostelSecy=new CouncilUserClass("Adya","Junior Girls  Secretary","9629469172"," adya@iitdh.ac.in",R.drawable.anu);
